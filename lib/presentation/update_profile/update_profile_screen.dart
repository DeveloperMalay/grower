...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
  ...
  void initState() {
    super.initState();
    RawKeyboard.instance.addListener(_handleKeyboardVisibility);
  }

  @override
  void dispose() {
    super.dispose();
    RawKeyboard.instance.removeListener(_handleKeyboardVisibility);
  }

  void _handleKeyboardVisibility(RawKeyEvent event) {
